      ...
      <div className={styles["bio-grid"]}>
          <div>
              ...
              <h4>
                ...
                <br /><br />
                When I’m not making or fixing things I like to watch <a className="global-border-thin" href="https://www.icheckmovies.com/profiles/mskinsm/" target="_blank">films</a> (a lot of them), <Link className="global-border-thin" to="/otherwork">paint and draw</Link> (yeah I guess that’s still making things), view the occasional <a className="global-border-thin" href="https://www.reddit.com/r/AccidentalRenaissance/" target="_blank">reddit thread</a>, <a className="global-border-thin" href="https://www.youtube.com/watch?v=aSQzDC8RSeE&ab_channel=Munchies" target="_blank">cook</a> and <a className="global-border-thin" href="https://i.giphy.com/media/LQwJIMzxbHgjK/giphy.webp" target="_blank">eat</a>.</h4>
          </div>
